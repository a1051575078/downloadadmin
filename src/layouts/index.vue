<template>
	<div :class="classObj" class="vue-admin-beautiful-wrapper">
		<div v-if="'horizontal' === layout" :class="{fixed: header === 'fixed','no-tabs-bar': tabsBar === 'false' || tabsBar === false,}" class="layout-container-horizontal">
		...
		<div v-else :class="{fixed: header === 'fixed','no-tabs-bar': tabsBar === 'false' || tabsBar === false,}" class="layout-container-vertical">
